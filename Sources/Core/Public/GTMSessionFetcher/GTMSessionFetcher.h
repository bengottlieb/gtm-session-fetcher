...
// skipBackgroundTask property to YES.
    ...
    (TARGET_OS_IOS || TARGET_OS_TV || TARGET_OS_MACCATALYST || TARGET_VISION_OS)
...
#if (TARGET_OS_IOS || TARGET_VISION_OS) && defined(__IPHONE_13_0) && __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_13_0
